...
menu += "<li class='nav-item'><a class='nav-link' href='principal.jsp?CONTENIDO=9.Perfil/padrinosFormulario.jsp&accion=Adicionar' style='padding: 8px 20px; font-size: 1.2rem; color: black; font-weight: bold;'>";
...
menu += "<li><a class='dropdown-item d-flex align-items-center' href='principal.jsp?CONTENIDO=9.Perfil/verMisDonaciones.jsp' style='padding: 10px 15px; font-size: 1.2rem; color: black; font-weight: bold;'>";
...
menu += "<li><a class='dropdown-item d-flex align-items-center' href='principal.jsp?CONTENIDO=9.Perfil/verMisAdopciones.jsp' style='padding: 10px 15px; font-size: 1.2rem; color: black; font-weight: bold;'>";
...
menu += "<li><a class='dropdown-item d-flex align-items-center' href='principal.jsp?CONTENIDO=9.Perfil/verMisApadrinamientos.jsp' style='padding: 10px 15px; font-size: 1.2rem; color: black; font-weight: bold;'>";
