...
<%
    ...
    for (int j = 0; j < datosApadrinamiento.size(); j++) {
        ...
        if ("C".equals(tipoUsuario)) {
            listaApadrinamiento += "<h2 style='font-weight: bold;'>Mi Apadrinamiento</h2>";
        } else {
            listaApadrinamiento += "<h2 style='font-weight: bold;'>Código padripet: " + apadrinamiento.getCodigo() + "</h2>";
        }
