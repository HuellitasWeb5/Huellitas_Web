...
<%
    ...
    for (int i = 0; i < datos.size(); i++) {
        ...
        if (mostrarMascota) {
            ...
            lista += "<a class='nav-link' href='principal.jsp?CONTENIDO=7.Adopcion/formularioInformacion.jsp&accion=Adicionar&codigoMascota="+mascota.getCodigo()+"&nombre=" + nombreTipoPersona+"'><button class='btn-otro'>Adoptar</button></a>";
            lista += "</div>";
            lista += "</div>";
            lista += "</div>";
        }
