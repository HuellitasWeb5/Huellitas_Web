...
<html lang="es">
    <head>
        ...
        <title>Formulario de Pre-Adopción</title>
                ...
                <div class="contenedor-tarjetas">
                    ...
                    <div class="tableDatos">
                        ...
                        <div class="datos-con-foto">
                            ...
                            <div class="foto">
                                <img id="fotoMascota" name="fotoMascota" class="fotoPreview" src="presentacion/mascota/<%= mascota.getFoto()%>" alt="Foto de <%= mascota.getNombre()%>" style="width: 100px; height: 100px;">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            if (codigoDeMascota != null && codigoDeMascota !== "") {
                ...
                if (indiceMascota !== false) {
                    ...
                    document.getElementById("nombreMascota").value = nombreMascota;
                    document.getElementById("genero").value = mostrarGenero(genero);
                    document.getElementById("direccion").value = tamano; // Aquí utilizo "direccion" para almacenar el tamaño de la mascota
                    document.getElementById("residencia").value = cuidadosEspeciales;
                    document.getElementById("fechaNacimiento").value = fechaNacimiento;
