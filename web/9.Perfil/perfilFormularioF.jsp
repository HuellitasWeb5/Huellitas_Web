...
<div class="card-carousel">
    <div class="card">
        ...
        <div class="card-body">
            <form name="formulario" method="post" action="principal.jsp?CONTENIDO=9.Perfil/perfilActualizarF.jsp" enctype="multipart/form-data" onsubmit="return validarContraseña();">
...
function validarContraseña() {
    ...
    if (mensajeError !== '') {
        alert(mensajeError);
        return false; // Evitar que se continúe con la modificación
    }

    return true; // Permitir que se continúe si todo está correcto
}

function modificar(identificacion) {
    // Validar la contraseña antes de modificar
    if (validarContraseña()) {
        const resultado = confirm("Tus datos han sido modificados, deberás iniciar sesión de nuevo.");
        if (resultado) {
